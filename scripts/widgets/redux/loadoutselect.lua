...
--11-10-17 DST CHANGE - WHAAATS UP GUYS ITS ME PICKLEPLAYER33 HERE AGAIN TO RIP MORE CODE OUT OF PERFECTLY FINE DOCUMENTS, DONT FORGET TO LIKE AND SUBSCRIBE AND SOMETHING SOMETHING BELL THING
...
local LoadoutSelect = Class(Widget, function(self, profile, default_character)
	...
	--[[    --TBH, THIS NEW FEATURE IS UGLY ANYWAYS.
